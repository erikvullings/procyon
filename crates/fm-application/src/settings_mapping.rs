...
pub(crate) fn settings_to_dto(settings: Settings) -> SettingsDto {
    SettingsDto {
        ...
        language: match settings.language {
            ...
            Language::Fr => LanguageDto::Fr,
            Language::Es => LanguageDto::Es,
            Language::It => LanguageDto::It,
            Language::Pt => LanguageDto::Pt,
            Language::Pl => LanguageDto::Pl,
        },
...
pub(crate) fn settings_from_dto(settings: SettingsDto) -> Settings {
    Settings {
        ...
        language: match settings.language {
            ...
            LanguageDto::Fr => Language::Fr,
            LanguageDto::Es => Language::Es,
            LanguageDto::It => Language::It,
            LanguageDto::Pt => Language::Pt,
            LanguageDto::Pl => Language::Pl,
        },
        font_size: settings.font_size,
        row_height: settings.row_height,
        date_format: match settings.date_format {
