...
pub use files::{
    ...
    OpenStructuredViewResponseDto, PptxPreviewResourceDto, PptxPreviewSessionRequestDto,
    PptxPreviewSlideDto, ReadDocxPreviewResourceRequestDto, ReadDocxPreviewResourceResponseDto,
    ReadFileRangeRequestDto, ReadFileRangeResponseDto, ReadPptxPreviewResourceRequestDto,
