      ...
      return m('div.diagnostics-view', [
        ...
        m('section.diagnostics-section', [
          ...
          m('dl', [
            ...
            m('dt', t('diagnostics', 'semanticComponentAuthority')),
            m('dd', diag.runtimeCapabilities.semanticComponentAuthority),
            m('dt', t('diagnostics', 'semanticRuntimeExecutableDownload')),
            m('dd', diag.runtimeCapabilities.semanticRuntimeExecutableDownload),
          ]),
        ]),
...
async function copyDiagnosticsToClipboard(diag: DiagnosticsView): Promise<void> {
  const lines = [
    ...
    `Semantic component authority: ${diag.runtimeCapabilities.semanticComponentAuthority}`,
    `Semantic executable download: ${diag.runtimeCapabilities.semanticRuntimeExecutableDownload}`,
    '',
    '=== Connection ===',
