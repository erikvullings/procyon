...
**Viewing & editing**
- F3 Lister-style instant large-file viewer with lazy search, bounded semantic DOCX and paged PPTX
  content previews, and native playback for short videos; large/MKV videos offer OS-default
  external playback without loading the file into memory
